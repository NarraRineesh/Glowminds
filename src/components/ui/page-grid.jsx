...
const VARIANTS = {
  ...
  sidebar: 'grid grid-cols-1 gap-4 md:grid-cols-[minmax(220px,260px)_minmax(0,1fr)] [&>*]:min-h-0 [&>*]:min-w-0',
  sidebarWide: 'grid grid-cols-1 gap-4 md:grid-cols-[minmax(240px,280px)_minmax(0,1fr)] [&>*]:min-h-0 [&>*]:min-w-0',
  sidebarWideRight: 'grid grid-cols-1 gap-4 md:grid-cols-[minmax(0,1fr)_minmax(240px,280px)] [&>*]:min-h-0 [&>*]:min-w-0',
